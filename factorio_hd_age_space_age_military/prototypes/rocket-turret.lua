if not settings.startup["f_hd_a_sa_m_disable_rocket_turret_shooting_animation"].value then
	...
	local temp_rocket_turret = {
		layers = {
			util.sprite_load(
			"__factorio_hd_age_space_age_military__/data/space-age/graphics/entity/rocket-turret/rocket-turret-shooting",
				{
					slice = 1,
					direction_count = 64,
			...
			util.sprite_load(
			"__factorio_hd_age_space_age_military__/data/space-age/graphics/entity/rocket-turret/rocket-turret-shooting-mask",
				{
					flags = { "mask" },
