...
![Factorio HD and QoL Age Logo](https://codeberg.org/Ingo_Igel/Factorio_HD_Age_and_Factorio_QoL_Age/raw/branch/main/.gallery/Factorio_HD_and_QoL_Age_Logo.png)

This project consists of two parts. First are the HD Age mods and second are the QoL Age mods.

The HD Age mods use AI-upscaled textures and spritesheets to improve the game's visuals, while the QoL Age mods contain quality-of-life tweaks.

This repository contains the source code for all these modifications. For resource reasons, no textures and sptritesheets are included. Only the source code, logos and thumbnails are available here. To access the textures and sptritesheets, please download the corresponding mod from the [Factorio Mod Portal](https://mods.factorio.com/user/Ingo_Igel).

### Instalation

Download mods either in-game or via the [Factorio Mod Portal](https://mods.factorio.com/user/Ingo_Igel)
