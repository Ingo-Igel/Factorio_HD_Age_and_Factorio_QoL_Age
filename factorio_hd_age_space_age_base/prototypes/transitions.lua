...
data.raw["tile"]["foundation"].transitions_between_transitions = {
	{
		...
		effect_map_layout = {
			spritesheet =
			"__factorio_hd_age_space_age_base__/data/base/graphics/terrain/effect-maps/water-stone-to-land-mask.png",
			o_transition_count = 0
		}
	},
	{
		...
		spritesheet =
		"__factorio_hd_age_space_age_base__/data/base/graphics/terrain/out-of-map-transition/concrete-out-of-map-transition-b.png",
		layout = tile_spritesheet_layout_hd.transition_3_3_3_1_0,
	},
	{
		...
		offset_background_layer_by_tile_layer = true,
		spritesheet =
		"__factorio_hd_age_space_age_base__/data/base/graphics/terrain/out-of-map-transition/concrete-shore-out-of-map-transition.png",
		layout = tile_spritesheet_layout_hd.transition_3_3_3_1_0,
		effect_map_layout = {
			spritesheet =
			"__factorio_hd_age_space_age_base__/data/base/graphics/terrain/effect-maps/water-stone-to-out-of-map-mask.png",
