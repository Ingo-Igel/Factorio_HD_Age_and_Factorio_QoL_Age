	...
	local concrete_transitions = {
		{
			...
			effect_map_layout = {
				spritesheet =
				"__factorio_hd_age_base_game_base__/data/base/graphics/terrain/effect-maps/water-stone-mask.png",
	...
	local concrete_transitions_between_transitions = {
		{
			...
			effect_map_layout = {
				spritesheet =
				"__factorio_hd_age_base_game_base__/data/base/graphics/terrain/effect-maps/water-stone-to-land-mask.png",
				o_transition_count = 0
			}
		},
		{
		...
		},
		{
			...
			effect_map_layout = {
				spritesheet =
				"__factorio_hd_age_base_game_base__/data/base/graphics/terrain/effect-maps/water-stone-to-out-of-map-mask.png",
	...
	local stone_path_transitions = {
		{
			...
			transition_group = water_transition_group_id,
			spritesheet =
			"__factorio_hd_age_base_game_base__/data/base/graphics/terrain/water-transitions/stone-path.png",
			layout = tile_spritesheet_layout_hd.transition_8_8_8_4_4,
			background_enabled = false,
			effect_map_layout = {
				spritesheet =
