...
* [Automatic Underground Pipe Connectors for 2.1](https://mods.factorio.com/mod/automatic-underground-pipe-connectors21) by [Maeximus](https://mods.factorio.com/user/Maeximus)
* [Belt Visualizer](https://mods.factorio.com/mod/belt-visualizer) by [_CodeGreen](https://mods.factorio.com/user/_CodeGreen)
* [Better zero & Q signal](https://mods.factorio.com/mod/rs-better-zero) by [repne.scasb](https://mods.factorio.com/user/repne.scasb)
* [Blueberry Excavation](https://mods.factorio.com/mod/bbexcavation) by [q2s2t](https://mods.factorio.com/user/q2s2t)
* [Car Logistics](https://mods.factorio.com/mod/CarLogistics) by [Malidictus](https://mods.factorio.com/user/Malidictus)
* [Change recipe quality without re-selecting recipe](https://mods.factorio.com/mod/change-recipe-quality-without-re-selecting-recipe) by [Quezler](https://mods.factorio.com/user/Quezler)
* [Circuit Visualizer Fork](https://mods.factorio.com/mod/circuit_visualizer_fork) by [zinful](https://mods.factorio.com/user/zinful)
* [Copy Paste Modules](https://mods.factorio.com/mod/CopyPasteModules) by [kajacx](https://mods.factorio.com/user/kajacx)
* [Corpse Marker](https://mods.factorio.com/mod/some-corpsemarker) by [someone1337](https://mods.factorio.com/user/someone1337)
...
* [Even Distribution](https://mods.factorio.com/mod/even-distribution) by [321freddy](https://mods.factorio.com/user/321freddy)
...
* [Heat Visualizer](https://mods.factorio.com/mod/heat-visualizer) by [justarandomgeek](https://mods.factorio.com/user/justarandomgeek)
...
* [More Parameters](https://mods.factorio.com/mod/more-parameters) by [Aroto](https://mods.factorio.com/user/Aroto)
...
* [Night Vision 1x1](https://mods.factorio.com/mod/night-vision-1x1) by [sakuro](https://mods.factorio.com/user/sakuro)
...
* [Pollution Scaling](https://mods.factorio.com/mod/pollution-scaling) by [ilbjanissary](https://mods.factorio.com/user/ilbjanissary)
* [Power Grid Comb (Temporary 2.1 Patch)](https://mods.factorio.com/mod/power-grid-comb-temp-21-patch) by [Joelbu](https://mods.factorio.com/user/Joelbu)
* [Production Rates Calculator Extreme](https://mods.factorio.com/mod/sw-rates-calc-extreme) by [SWeini](https://mods.factorio.com/user/SWeini)
* [Rate Calculator](https://mods.factorio.com/mod/RateCalculator) by [raiguard](https://mods.factorio.com/user/raiguard)
* [Resource Map Label Marker Fork](https://mods.factorio.com/mod/resource-map-label-marker-fork) by [zinful](https://mods.factorio.com/user/zinful)
...
* [Transport Belt Direction Indicator](https://mods.factorio.com/mod/belt-direction-indicator) by [Supershadow30](https://mods.factorio.com/user/Supershadow30)
...
* [Modpack](https://mods.factorio.com/mod/factorio_hd_age_modpack) +8 GB of VRAM | at least 14 GB of VRAM is recommended
  or [Modpack (all optional)](https://mods.factorio.com/mod/factorio_hd_age_modpack_optional) Additional VRAM consumption depends on the enabled mods.
    ...
    * [Recycler](https://mods.factorio.com/mod/factorio_hd_age_quality) +180 MB of VRAM
